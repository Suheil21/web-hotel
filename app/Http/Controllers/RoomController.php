...
class RoomController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->file('photo')->storeAs('img/room', $fileName);
        $photo = 'img/room/' . $fileName;
    ...
    public function destroy(Room $room)
    {
        try {
            ...
            // throw $th->getMessage();
            $errorMsg = 'Ruangan sudah pernah / sedang di booking';
            ...
            return redirect(route('room.index'))->with('error', $errorMsg);
        }
    }
}
